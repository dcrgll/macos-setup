...
code --install-extension LevitatingBusinessMan.hyper-vsc
...
module.exports = {
  config: {
    ...
    hyperline: {
      plugins: ["ip", "cpu", "memory", "network", "battery", "spotify"]
    },
    ...
    selectionColor: "rgba(53,255,105, 0.8)",
